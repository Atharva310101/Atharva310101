...
<a href="https://atharva310101.github.io">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=26&duration=3000&pause=1000&color=2F80ED&center=true&vCenter=true&width=750&lines=Hi%2C+I'm+Atharva+Pargaonkar+%F0%9F%91%8B;AI+Engineer+%7C+Data+Engineer+%7C+ML+Engineer;Agentic+AI+%C2%B7+RAG+Pipelines+%C2%B7+Production+ML;Open+to+Relocate+%C2%B7+Immediate+Joiner" alt="Typing SVG" />
</a>

<br/>

**M.S. Computer Science · Boise State University (GPA 3.79) · Open to Relocation**
...
AI Software Engineer with production experience building **multi-agent workflows**, **RAG pipelines**, and **end-to-end data engineering systems**. I work across the full agentic stack — tool integrations with secure auth boundaries, stateful memory patterns, prompt injection defenses, output filtering guardrails, and LLM observability with decision traces and token telemetry. Proficient with **Claude, Gemini, and OpenAI** frontier models, including tool use, function calling, and multi-turn workflow design.

Published IEEE & arXiv researcher. Available immediately. Open to relocate anywhere in the US.

> 🎯 Targeting: **AI/ML Engineer · Data Engineer · Data Scientist · Data Analyst · Business Analyst**

> 📄 2 peer-reviewed publications · 6 certifications (AWS + AI) · STEM-OPT eligible
...
![XGBoost](https://img.shields.io/badge/XGBoost-E07B00?style=flat-square&logoColor=white)
...
|---|---|---|
| [📊 Coffee Sales & Customer Analytics](https://github.com/Atharva310101/End-to-End-E-commerce-Sales-Analysis-Project) | Data Anysis · SQL · Excel · Power BI · Business Analytics | Analyzed 4+ years of transactional coffee sales data; enabling enterprise‑level sales and customer insights using advanced Excel analytics |
...
**Publications**
- 📄 **[arXiv 2024]** *Exploring Requirements Elicitation from User Reviews using LLMs* — 97% precision on 5,000+ app reviews
- 📄 **[IEEE 2023]** *Remote Landslide Detection Using Semantic Segmentation* — peer-reviewed
...
**Open to AI/ML Engineer · Data Engineer · Data Scientist · Data Analyst · Business Analyst**

*Available immediately · Willing to relocate anywhere in the US · STEM-OPT authorized*

[![LinkedIn](https://img.shields.io/badge/Let's%20Connect%20on%20LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/atharva-pargaonkar)
[![Portfolio](https://img.shields.io/badge/View%20Portfolio-000000?style=for-the-badge&logo=vercel&logoColor=white)](https://atharva310101.github.io)
